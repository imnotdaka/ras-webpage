    ...
    return (
        <footer className="bg-white w-full shadow dark:bg-gray-900">
            <div className="w-full max-w-screen-xl mx-auto p-3 md:py-8">
                ...
                <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/" className="hover:underline">Rosario Autos Sport</a>. All Rights Reserved.</span>
            </div>
        </footer>
    )
}
